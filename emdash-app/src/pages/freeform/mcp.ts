...
// ╔══════════════════════════════════════════════════════════════════════════╗
// ║  DEPRECATED — use packages/emdash-freeform-mcp/ instead                  ║
// ║                                                                          ║
// ║  This in-process Astro route is superseded by the standalone Cloudflare  ║
// ║  Worker in packages/emdash-freeform-mcp/. The Worker is self-deployed    ║
// ║  per customer and communicates with the plugin over HTTP, which removes  ║
// ║  the need for an env.SELF service binding in the main site Worker.       ║
// ║                                                                          ║
// ║  This file is kept as a fallback for local development and for sites     ║
// ║  that have not yet deployed the standalone Worker. It will be removed    ║
// ║  once the MCP Worker package is publicly available.                      ║
// ╚══════════════════════════════════════════════════════════════════════════╝
